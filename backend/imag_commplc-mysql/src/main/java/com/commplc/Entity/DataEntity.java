...
public class DataEntity {
    ...
    @Column(name = "target", columnDefinition = "default ''")
    private String target;

    public DataEntity(String line, String status, String speed, String counterOut, String runtime, String time, String date, String shift) {
        this.line = line;
        this.status = status;
        this.speed = speed;
